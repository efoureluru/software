                ...
                <header className="bg-slate-900 border-b border-slate-800 text-white p-3 md:p-4 shadow-xl z-20 sticky top-0">
                    <div className="container mx-auto flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3 md:gap-4">
                            ...
                            <div>
                                <h1 className="text-lg md:text-xl font-black tracking-tight text-white leading-none">EFOUR <span className="text-amber-400">POS</span> <span className="text-xs text-amber-400 font-bold ml-1 bg-amber-900 px-1 rounded ring-1 ring-amber-500/50">v3.3</span></h1>
